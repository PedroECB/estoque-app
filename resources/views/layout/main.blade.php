        ...
        <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                  <ul class="navbar-nav">
                    ...
                    <li class="nav-item {{request()->routeIs('fornecedores.index')?'active':''}} mr-3">
                      <a class="nav-link font-weight-bold" href="{{route('fornecedores.index')}}"><i class="fa fa-truck" aria-hidden="true"></i> Fornecedores</a>
                    </li>
